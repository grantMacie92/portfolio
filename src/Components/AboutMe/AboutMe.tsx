...
const AboutMe = () => {
    ...
    return (
        <div id="about">
            ...
            <span>
                My background spans React and TypeScript on the frontend and .NET-based services with SQL data systems on the backend. I am particularly drawn to system modernization, clean architecture, and building scalable tools that grow alongside both users and engineering teams.            </span>
            </span>
        </div>
    )
}
